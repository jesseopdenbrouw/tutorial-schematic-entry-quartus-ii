...
echo Removing all db directories...
FOR /D /r %%G in ("db*") DO rd /s/q %%G
echo Removing all incremental_db directories...
FOR /D /r %%G in ("incremental_db*") DO rd /s/q %%G
echo Removing all simulations directories...
FOR /D /r %%G in ("simulation*") DO rd /s/q %%G
echo Removing all output_files directories...
