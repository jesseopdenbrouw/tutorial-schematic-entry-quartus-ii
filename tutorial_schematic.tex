...
%% v1.7, 17-sep-2018 - new screenshot install_flow.vbs et al
%% v1.8, 18-aug-2019 - typos and links with https
%% v1.9.  4-sep-2019 - typos and installation on own laptop
%%
...
\usepackage[a4paper,bindingoffset=0.2in,outer=0.8in,inner=0.8in,top=1in,
...
bestandsnamen! Bestandsnamen altijd beginnen met een letter!}
...
\caption{De flow is ge\"{\i}nstalleerd.}
...
%Noot: als je de eerste regel in figuur~\ref{fig:022symbolselection} niet
...
\medskip
\lstinputlisting[caption=Windows opruimscript,label=cod:opruim]{remove_unwanted_files.cmd}
